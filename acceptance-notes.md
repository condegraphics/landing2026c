...
La actualización posterior reemplazó el fondo del hero por `img/hero-2026-ok.jpg`, verificada en 1920 × 934 px. El hero respeta esa proporción en escritorio, libera el alto proporcional en tablet/móvil y usa un H1 de 70px con line-height de 78px en escritorio. Se conserva un overlay azul para la legibilidad del texto.
