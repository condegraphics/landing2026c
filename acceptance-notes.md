...
La experiencia posterior al envío fue revisada según buenas prácticas de feedback accesible: la ruta normal muestra un mensaje breve inline con `role="status"` y `aria-live="polite"`, sin sacar al usuario de la landing ni utilizar un popup bloqueante. El mensaje comunica recepción correcta y una primera orientación posterior.
